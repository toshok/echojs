...
LIBUV_DEF=-DHAVE_LIBUV=1
else
LIBUV_DEF=-DNOOP_RUNLOOP=1
endif

ifeq ($(HOST_CPU),x86_64)
LINUX_ARCH=-arch x86_64
LINUX_CFLAGS=$(CFLAGS) -DTARGET_CPU_AMD64=1 -DEJS_BITS_PER_WORD=64 -DIS_LITTLE_ENDIAN=1 $(LIBUV_DEF) -D_GNU_SOURCE
else
LINUX_ARCH=-arch x86
LINUX_CFLAGS=$(CFLAGS) -DTARGET_CPU_X86=1 -DEJS_BITS_PER_WORD=32 -DIS_LITTLE_ENDIAN=1 $(LIBUV_DEF) -D_GNU_SOURCE
endif
