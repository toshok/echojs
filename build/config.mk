...
IOSSIM_ARCH=-arch arm64
IOSSIM_TRIPLE=arm64-apple-ios-simulator
IOSSIM_MTRIPLE="x86_64-apple-ios$(MIN_IOS_VERSION).0"
IOSSIM_ARCH_FLAGS=-DTARGET_CPU_AARCH64=1 -DEJS_BITS_PER_WORD=64 -DIS_LITTLE_ENDIAN=1
...
IOSDEV_ARCH=-arch aarch64
IOSDEV_TRIPLE=arm64-apple-ios
