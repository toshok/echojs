...
ifneq ($(TRAVIS),)
RUNLOOP_FLAGS=-DHAVE_LIBEV=1
RUNLOOP_IMPL=libev
else
RUNLOOP_FLAGS=-DHAVE_LIBUV=1
RUNLOOP_IMPL=libuv
endif

ifeq ($(HOST_CPU),x86_64)
LINUX_ARCH=-arch x86_64
LINUX_CFLAGS=$(CFLAGS) -DTARGET_CPU_AMD64=1 -DEJS_BITS_PER_WORD=64 -DIS_LITTLE_ENDIAN=1 $(RUNLOOP_FLAGS)
else
LINUX_ARCH=-arch x86
LINUX_CFLAGS=$(CFLAGS) -DTARGET_CPU_X86=1 -DEJS_BITS_PER_WORD=32 -DIS_LITTLE_ENDIAN=1 $(RUNLOOP_FLAGS)
endif

else

# osx host stuff
RUNLOOP_IMPL=nsrunloop
