...
sudo update-alternatives --install /usr/bin/llvm-config llvm-config /usr/bin/llvm-config-3.8 10 --force
sudo update-alternatives --install /usr/bin/llvm-dis llvm-dis /usr/bin/llvm-dis-3.8 10 --force
sudo update-alternatives --install /usr/bin/llvm-as  llvm-as  /usr/bin/llvm-as-3.8 10 --force
