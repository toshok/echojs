...
static EJSObject *Call_allocate() { return (EJSObject *)_ejs_gc_new(Call); }

static ejsval Call_impl(ejsval env, ejsval _this, int argc, ejsval *args) {
    EJS_NOT_IMPLEMENTED();
}
...
ejsval Call_prototype_toString(ejsval env, ejsval _this, int argc,
                               ejsval *args) {
    std::string str;
...
ejsval Call_prototype_dump(ejsval env, ejsval _this, int argc, ejsval *args) {
    ((Call *)EJSVAL_TO_OBJECT(_this))->llvm_call->dump();
    return _ejs_undefined;
}

ejsval Call_prototype_setOnlyReadsMemory(ejsval env, ejsval _this, int argc,
                                         ejsval *args) {
...
ejsval Call_prototype_setDoesNotAccessMemory(ejsval env, ejsval _this, int argc,
                                             ejsval *args) {
    Call *call = ((Call *)EJSVAL_TO_OBJECT(_this));
...
ejsval Call_prototype_setDoesNotThrow(ejsval env, ejsval _this, int argc,
                                      ejsval *args) {
    Call *call = ((Call *)EJSVAL_TO_OBJECT(_this));
...
ejsval Call_prototype_setStructRet(ejsval env, ejsval _this, int argc,
                                   ejsval *args) {
    Call *call = ((Call *)EJSVAL_TO_OBJECT(_this));
...
llvm::CallInst *Call_GetLLVMObj(ejsval val) {
    if (EJSVAL_IS_NULL(val))
        return NULL;
    return ((Call *)EJSVAL_TO_OBJECT(val))->llvm_call;
}

void Call_init(ejsval exports) {
    ...
    _ejs_Call_prototype =
        _ejs_object_new(_ejs_Object_prototype, &_ejs_Call_specops);

    ejsval tmpobj = _ejs_function_new_utf8(_ejs_null, "LLVMCall",
                                           (EJSClosureFunc)Call_impl);
    _ejs_Call = tmpobj;

#define PROTO_METHOD(x)                                                        \
    EJS_INSTALL_ATOM_FUNCTION(_ejs_Call_prototype, x, Call_prototype_##x)
...
static EJSObject *Invoke_allocate() { return (EJSObject *)_ejs_gc_new(Invoke); }

static ejsval Invoke_impl(ejsval env, ejsval _this, int argc, ejsval *args) {
    EJS_NOT_IMPLEMENTED();
}

ejsval Invoke_new(llvm::InvokeInst *llvm_invoke) {
    ejsval result =
        _ejs_object_new(_ejs_Invoke_prototype, &_ejs_Invoke_specops);
    ((Invoke *)EJSVAL_TO_OBJECT(result))->llvm_invoke = llvm_invoke;
    return result;
}

ejsval Invoke_prototype_toString(ejsval env, ejsval _this, int argc,
                                 ejsval *args) {
    std::string str;
    llvm::raw_string_ostream str_ostream(str);
...
ejsval Invoke_prototype_dump(ejsval env, ejsval _this, int argc, ejsval *args) {
    ((Invoke *)EJSVAL_TO_OBJECT(_this))->llvm_invoke->dump();
    return _ejs_undefined;
}

ejsval Invoke_prototype_setOnlyReadsMemory(ejsval env, ejsval _this, int argc,
                                           ejsval *args) {
...
ejsval Invoke_prototype_setDoesNotAccessMemory(ejsval env, ejsval _this,
...
ejsval Invoke_prototype_setDoesNotThrow(ejsval env, ejsval _this, int argc,
                                        ejsval *args) {
    Invoke *invoke = ((Invoke *)EJSVAL_TO_OBJECT(_this));
...
ejsval Invoke_prototype_setStructRet(ejsval env, ejsval _this, int argc,
                                     ejsval *args) {
    Invoke *invoke = ((Invoke *)EJSVAL_TO_OBJECT(_this));
...
llvm::InvokeInst *Invoke_GetLLVMObj(ejsval val) {
    if (EJSVAL_IS_NULL(val))
        return NULL;
...
void Invoke_init(ejsval exports) {
    ...
    _ejs_Invoke_prototype =
        _ejs_object_new(_ejs_Object_prototype, &_ejs_Invoke_specops);

    _ejs_Invoke = _ejs_function_new_utf8_with_proto(_ejs_null, "LLVMInvoke",
                                                    (EJSClosureFunc)Invoke_impl,
                                                    _ejs_Invoke_prototype);

    _ejs_object_setprop_utf8(exports, "Invoke", _ejs_Invoke);

#define PROTO_METHOD(x)                                                        \
    EJS_INSTALL_ATOM_FUNCTION(_ejs_Invoke_prototype, x, Invoke_prototype_##x)
