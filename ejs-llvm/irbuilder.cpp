...
static ejsval IRBuilder_impl(ejsval env, ejsval _this, int argc, ejsval *args) {
    EJS_NOT_IMPLEMENTED();
}
...
ejsval IRBuilder_setInsertPoint(ejsval env, ejsval _this, int argc,
                                ejsval *args) {
...
ejsval IRBuilder_setInsertPointStartBB(ejsval env, ejsval _this, int argc,
                                       ejsval *args) {
    REQ_LLVM_BB_ARG(0, bb);
    if (bb != NULL)
...
ejsval IRBuilder_getInsertBlock(ejsval env, ejsval _this, int argc,
                                ejsval *args) {
...
ejsval IRBuilder_createRet(ejsval env, ejsval _this, int argc, ejsval *args) {
    REQ_LLVM_VAL_ARG(0, val);
    return Value_new(_llvm_builder.CreateRet(val));
}

ejsval IRBuilder_createRetVoid(ejsval env, ejsval _this, int argc,
                               ejsval *args) {
    return Value_new(_llvm_builder.CreateRetVoid());
}

ejsval IRBuilder_createPointerCast(ejsval env, ejsval _this, int argc,
                                   ejsval *args) {
    REQ_LLVM_VAL_ARG(0, val);
...
ejsval IRBuilder_createFPCast(ejsval env, ejsval _this, int argc,
                              ejsval *args) {
    REQ_LLVM_VAL_ARG(0, val);
    REQ_LLVM_TYPE_ARG(1, ty);
    FALLBACK_EMPTY_UTF8_ARG(2, name);
...
ejsval IRBuilder_createCall(ejsval env, ejsval _this, int argc, ejsval *args) {
...
ejsval IRBuilder_createInvoke(ejsval env, ejsval _this, int argc,
                              ejsval *args) {
    REQ_LLVM_VAL_ARG(0, callee);
    REQ_ARRAY_ARG(1, argv);
    ...
    return Invoke_new(_llvm_builder.CreateInvoke(callee, normal_dest,
                                                 unwind_dest, ArgsV, name));
}

ejsval IRBuilder_createFAdd(ejsval env, ejsval _this, int argc, ejsval *args) {
...
ejsval IRBuilder_createAlloca(ejsval env, ejsval _this, int argc,
                              ejsval *args) {
...
ejsval IRBuilder_createLoad(ejsval env, ejsval _this, int argc, ejsval *args) {
    REQ_LLVM_VAL_ARG(0, val);
    FALLBACK_EMPTY_UTF8_ARG(1, name);
...
ejsval IRBuilder_createStore(ejsval env, ejsval _this, int argc, ejsval *args) {
    REQ_LLVM_VAL_ARG(0, val);
...
ejsval IRBuilder_createExtractElement(ejsval env, ejsval _this, int argc,
                                      ejsval *args) {
    REQ_LLVM_VAL_ARG(0, val);
...
ejsval IRBuilder_createExtractValue(ejsval env, ejsval _this, int argc,
                                    ejsval *args) {
    REQ_LLVM_VAL_ARG(0, val);
    REQ_INT_ARG(1, idx);
    FALLBACK_EMPTY_UTF8_ARG(2, name);
...
ejsval IRBuilder_createGetElementPointer(ejsval env, ejsval _this, int argc,
                                         ejsval *args) {
    REQ_LLVM_VAL_ARG(0, val);
...
ejsval IRBuilder_createInBoundsGetElementPointer(ejsval env, ejsval _this,
...
ejsval IRBuilder_createStructGetElementPointer(ejsval env, ejsval _this,
                                               int argc, ejsval *args) {
    REQ_LLVM_VAL_ARG(0, val);
    REQ_INT_ARG(1, idx);
    FALLBACK_EMPTY_UTF8_ARG(2, name);
...
ejsval IRBuilder_createICmpEq(ejsval env, ejsval _this, int argc,
                              ejsval *args) {
    REQ_LLVM_VAL_ARG(0, left);
    REQ_LLVM_VAL_ARG(1, right);
    FALLBACK_EMPTY_UTF8_ARG(2, name);
...
ejsval IRBuilder_createICmpSGt(ejsval env, ejsval _this, int argc,
                               ejsval *args) {
    REQ_LLVM_VAL_ARG(0, left);
    REQ_LLVM_VAL_ARG(1, right);
    FALLBACK_EMPTY_UTF8_ARG(2, name);
...
ejsval IRBuilder_createICmpUGt(ejsval env, ejsval _this, int argc,
                               ejsval *args) {
    REQ_LLVM_VAL_ARG(0, left);
    REQ_LLVM_VAL_ARG(1, right);
    FALLBACK_EMPTY_UTF8_ARG(2, name);
...
ejsval IRBuilder_createICmpUGE(ejsval env, ejsval _this, int argc,
                               ejsval *args) {
    REQ_LLVM_VAL_ARG(0, left);
    REQ_LLVM_VAL_ARG(1, right);
    FALLBACK_EMPTY_UTF8_ARG(2, name);
...
ejsval IRBuilder_createICmpULt(ejsval env, ejsval _this, int argc,
                               ejsval *args) {
    REQ_LLVM_VAL_ARG(0, left);
    REQ_LLVM_VAL_ARG(1, right);
    FALLBACK_EMPTY_UTF8_ARG(2, name);
...
ejsval IRBuilder_createBr(ejsval env, ejsval _this, int argc, ejsval *args) {
    REQ_LLVM_BB_ARG(0, dest);

    return Value_new(_llvm_builder.CreateBr(dest));
}

ejsval IRBuilder_createCondBr(ejsval env, ejsval _this, int argc,
                              ejsval *args) {
...
ejsval IRBuilder_createPhi(ejsval env, ejsval _this, int argc, ejsval *args) {
    abort();
#if notyet
    REQ_LLVM_TYPE_ARG(0, ty);
...
ejsval IRBuilder_createGlobalStringPtr(ejsval env, ejsval _this, int argc,
                                       ejsval *args) {
    REQ_UTF8_ARG(0, val);
    FALLBACK_EMPTY_UTF8_ARG(1, name);
...
ejsval IRBuilder_createUnreachable(ejsval env, ejsval _this, int argc,
                                   ejsval *args) {
    return Value_new(_llvm_builder.CreateUnreachable());
}

ejsval IRBuilder_createAnd(ejsval env, ejsval _this, int argc, ejsval *args) {
...
ejsval IRBuilder_createOr(ejsval env, ejsval _this, int argc, ejsval *args) {
    REQ_LLVM_VAL_ARG(0, lhs);
    REQ_LLVM_VAL_ARG(1, rhs);
    FALLBACK_EMPTY_UTF8_ARG(2, name);
...
ejsval IRBuilder_createZExt(ejsval env, ejsval _this, int argc, ejsval *args) {
...
ejsval IRBuilder_createIntToPtr(ejsval env, ejsval _this, int argc,
                                ejsval *args) {
    REQ_LLVM_VAL_ARG(0, V);
    REQ_LLVM_TYPE_ARG(1, dest_ty);
    FALLBACK_EMPTY_UTF8_ARG(2, name);
...
ejsval IRBuilder_createPtrToInt(ejsval env, ejsval _this, int argc,
                                ejsval *args) {
    REQ_LLVM_VAL_ARG(0, V);
    REQ_LLVM_TYPE_ARG(1, dest_ty);
    FALLBACK_EMPTY_UTF8_ARG(2, name);
...
ejsval IRBuilder_createBitCast(ejsval env, ejsval _this, int argc,
                               ejsval *args) {
    REQ_LLVM_VAL_ARG(0, V);
    REQ_LLVM_TYPE_ARG(1, dest_ty);
    FALLBACK_EMPTY_UTF8_ARG(2, name);
...
ejsval IRBuilder_createSwitch(ejsval env, ejsval _this, int argc,
                              ejsval *args) {
    REQ_LLVM_VAL_ARG(0, V);
...
ejsval IRBuilder_createSelect(ejsval env, ejsval _this, int argc,
                              ejsval *args) {
...
ejsval IRBuilder_createNswSub(ejsval env, ejsval _this, int argc,
                              ejsval *args) {
    REQ_LLVM_VAL_ARG(0, lhs);
    REQ_LLVM_VAL_ARG(1, rhs);
    FALLBACK_EMPTY_UTF8_ARG(2, name);
...
ejsval IRBuilder_createLandingPad(ejsval env, ejsval _this, int argc,
                                  ejsval *args) {
    REQ_LLVM_TYPE_ARG(0, ty);
    ...
    return LandingPad_new(
        _llvm_builder.CreateLandingPad(ty, persFn, num_clauses, name));
}

ejsval IRBuilder_createResume(ejsval env, ejsval _this, int argc,
                              ejsval *args) {
    REQ_LLVM_VAL_ARG(0, val);
...
ejsval IRBuilder_getCurrentDebugLocation(ejsval env, ejsval _this, int argc,
                                         ejsval *args) {
    return DebugLoc_new(_llvm_builder.getCurrentDebugLocation());
}

ejsval IRBuilder_setCurrentDebugLocation(ejsval env, ejsval _this, int argc,
                                         ejsval *args) {
...
void IRBuilder_init(ejsval exports) {
    ...
    _ejs_IRBuilder = _ejs_function_new_utf8_with_proto(
        _ejs_null, "LLVMIRBuilder", (EJSClosureFunc)IRBuilder_impl,
        _ejs_IRBuilder_prototype);

    _ejs_object_setprop_utf8(exports, "IRBuilder", _ejs_IRBuilder);

#define OBJ_METHOD(x)                                                          \
    EJS_INSTALL_ATOM_FUNCTION(_ejs_IRBuilder, x, IRBuilder_##x)
