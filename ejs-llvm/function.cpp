...
static ejsval Function_create(ejsval env, ejsval _this, int argc,
                              ejsval *args) {
    ejsval F = _this;
    if (!EJSVAL_IS_CONSTRUCTOR(F))
        _ejs_throw_nativeerror_utf8(
            EJS_TYPE_ERROR,
            "'this' in Function[Symbol.create] is not a constructor");
...
static ejsval Function_impl(ejsval env, ejsval _this, int argc, ejsval *args) {
    EJS_NOT_IMPLEMENTED();
}

ejsval Function_new(llvm::Function *llvm_fun) {
    ejsval result =
        _ejs_object_new(_ejs_Function_prototype, &_ejs_Function_specops);
    ((Function *)EJSVAL_TO_OBJECT(result))->llvm_fun = llvm_fun;
    return result;
}

ejsval Function_prototype_toString(ejsval env, ejsval _this, int argc,
                                   ejsval *args) {
    std::string str;
...
ejsval Function_prototype_dump(ejsval env, ejsval _this, int argc,
                               ejsval *args) {
    ((Function *)EJSVAL_TO_OBJECT(_this))->llvm_fun->dump();
    return _ejs_undefined;
}

ejsval Function_prototype_setOnlyReadsMemory(ejsval env, ejsval _this, int argc,
                                             ejsval *args) {
...
ejsval Function_prototype_setDoesNotAccessMemory(ejsval env, ejsval _this,
...
ejsval Function_prototype_setDoesNotThrow(ejsval env, ejsval _this, int argc,
                                          ejsval *args) {
    Function *fun = ((Function *)EJSVAL_TO_OBJECT(_this));
...
ejsval Function_prototype_setGC(ejsval env, ejsval _this, int argc,
                                ejsval *args) {
    Function *fun = ((Function *)EJSVAL_TO_OBJECT(_this));
    REQ_UTF8_ARG(0, name);
...
ejsval Function_prototype_setExternalLinkage(ejsval env, ejsval _this, int argc,
                                             ejsval *args) {
    Function *fun = ((Function *)EJSVAL_TO_OBJECT(_this));
...
ejsval Function_prototype_setInternalLinkage(ejsval env, ejsval _this, int argc,
                                             ejsval *args) {
    Function *fun = ((Function *)EJSVAL_TO_OBJECT(_this));
...
ejsval Function_prototype_setStructRet(ejsval env, ejsval _this, int argc,
                                       ejsval *args) {
    Function *fun = ((Function *)EJSVAL_TO_OBJECT(_this));
    fun->llvm_fun->addAttribute(1 /* first arg */, llvm::Attribute::StructRet);
    return _ejs_undefined;
}

ejsval Function_prototype_hasStructRetAttr(ejsval env, ejsval _this, int argc,
                                           ejsval *args) {
    Function *fun = ((Function *)EJSVAL_TO_OBJECT(_this));
    return fun->llvm_fun->hasStructRetAttr() ? _ejs_true : _ejs_false;
}

ejsval Function_prototype_get_args(ejsval env, ejsval _this, int argc,
                                   ejsval *args) {
    Function *fun = ((Function *)EJSVAL_TO_OBJECT(_this));
    ...
    unsigned Idx = 0;
    for (llvm::Function::arg_iterator AI = fun->llvm_fun->arg_begin();
         Idx != size; ++AI, ++Idx) {
...
ejsval Function_prototype_get_argSize(ejsval env, ejsval _this, int argc,
                                      ejsval *args) {
    Function *fun = ((Function *)EJSVAL_TO_OBJECT(_this));
    return NUMBER_TO_EJSVAL(fun->llvm_fun->arg_size());
}

ejsval Function_prototype_get_returnType(ejsval env, ejsval _this, int argc,
                                         ejsval *args) {
    Function *fun = ((Function *)EJSVAL_TO_OBJECT(_this));
    return Type_new(fun->llvm_fun->getReturnType());
}

ejsval Function_prototype_get_name(ejsval env, ejsval _this, int argc,
                                   ejsval *args) {
    Function *fun = ((Function *)EJSVAL_TO_OBJECT(_this));
...
ejsval Function_prototype_get_type(ejsval env, ejsval _this, int argc,
                                   ejsval *args) {
    Function *fun = ((Function *)EJSVAL_TO_OBJECT(_this));
    return FunctionType_new(fun->llvm_fun->getFunctionType());
}

ejsval Function_prototype_get_doesNotThrow(ejsval env, ejsval _this, int argc,
                                           ejsval *args) {
    Function *fun = ((Function *)EJSVAL_TO_OBJECT(_this));
    return BOOLEAN_TO_EJSVAL(fun->llvm_fun->doesNotThrow());
}

ejsval Function_prototype_get_doesNotAccessMemory(ejsval env, ejsval _this,
                                                  int argc, ejsval *args) {
    Function *fun = ((Function *)EJSVAL_TO_OBJECT(_this));
    return BOOLEAN_TO_EJSVAL(fun->llvm_fun->doesNotAccessMemory());
}

ejsval Function_prototype_get_onlyReadsMemory(ejsval env, ejsval _this,
                                              int argc, ejsval *args) {
    Function *fun = ((Function *)EJSVAL_TO_OBJECT(_this));
...
void Function_init(ejsval exports) {
    ...
    _ejs_Function_prototype =
        _ejs_object_new(_ejs_Object_prototype, &_ejs_Function_specops);

    _ejs_Function = _ejs_function_new_utf8_with_proto(
        _ejs_null, "LLVMFunction", (EJSClosureFunc)Function_impl,
        _ejs_Function_prototype);

    _ejs_object_setprop_utf8(exports, "Function", _ejs_Function);

#define PROTO_METHOD(x)                                                        \
    EJS_INSTALL_ATOM_FUNCTION(_ejs_Function_prototype, x,                      \
                              Function_prototype_##x)
#define PROTO_ACCESSOR(x)                                                      \
    EJS_INSTALL_ATOM_GETTER(_ejs_Function_prototype, x,                        \
                            Function_prototype_get_##x)
...
#undef PROTO_ACCESSOR
    ...
    EJS_INSTALL_SYMBOL_FUNCTION_FLAGS(_ejs_Function, create, Function_create,
