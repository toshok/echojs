...
void Function::Init(Handle<Object> target) {
    ...
    s_ct->InstanceTemplate()->SetAccessor(String::NewSymbol("args"),
                                          Function::GetArgs);
    s_ct->InstanceTemplate()->SetAccessor(String::NewSymbol("argSize"),
                                          Function::GetArgSize);
    s_ct->InstanceTemplate()->SetAccessor(String::NewSymbol("name"),
                                          Function::GetName);
    s_ct->InstanceTemplate()->SetAccessor(String::NewSymbol("returnType"),
                                          Function::GetReturnType);
    s_ct->InstanceTemplate()->SetAccessor(String::NewSymbol("type"),
                                          Function::GetType);
    s_ct->InstanceTemplate()->SetAccessor(String::NewSymbol("doesNotThrow"),
                                          Function::GetDoesNotThrow);
    s_ct->InstanceTemplate()->SetAccessor(String::NewSymbol("onlyReadsMemory"),
                                          Function::GetOnlyReadsMemory);
    s_ct->InstanceTemplate()->SetAccessor(
        String::NewSymbol("doesNotAccessMemory"),
        Function::GetDoesNotAccessMemory);

    NODE_SET_PROTOTYPE_METHOD(s_ct, "dump", Function::Dump);
    NODE_SET_PROTOTYPE_METHOD(s_ct, "setOnlyReadsMemory",
                              Function::SetOnlyReadsMemory);
    NODE_SET_PROTOTYPE_METHOD(s_ct, "setDoesNotAccessMemory",
                              Function::SetDoesNotAccessMemory);
    NODE_SET_PROTOTYPE_METHOD(s_ct, "setDoesNotThrow",
                              Function::SetDoesNotThrow);
    NODE_SET_PROTOTYPE_METHOD(s_ct, "setGC", Function::SetGC);
    NODE_SET_PROTOTYPE_METHOD(s_ct, "setExternalLinkage",
                              Function::SetInternalLinkage);
    NODE_SET_PROTOTYPE_METHOD(s_ct, "setInternalLinkage",
                              Function::SetInternalLinkage);
    ...
    NODE_SET_PROTOTYPE_METHOD(s_ct, "hasStructRetAttr",
                              Function::HasStructRetAttr);

    s_func = Persistent<v8::Function>::New(s_ct->GetFunction());
    target->Set(String::NewSymbol("LLVMFunction"), s_func);
}
...
Handle<v8::Value> Function::GetArgSize(Local<String> property,
...
Handle<v8::Value> Function::GetArgs(Local<String> property,
                                    const AccessorInfo &info) {
    HandleScope scope;
    Function *fun = ObjectWrap::Unwrap<Function>(info.This());
...
Handle<v8::Value> Function::GetName(Local<String> property,
                                    const AccessorInfo &info) {
    HandleScope scope;
    Function *fun = ObjectWrap::Unwrap<Function>(info.This());
...
Handle<v8::Value> Function::GetReturnType(Local<String> property,
                                          const AccessorInfo &info) {
    HandleScope scope;
    Function *fun = ObjectWrap::Unwrap<Function>(info.This());
...
Handle<v8::Value> Function::GetType(Local<String> property,
                                    const AccessorInfo &info) {
    HandleScope scope;
    Function *fun = ObjectWrap::Unwrap<Function>(info.This());
    Handle<v8::Value> result =
        FunctionType::New(fun->llvm_fun->getFunctionType());
    return scope.Close(result);
}

Handle<v8::Value> Function::GetDoesNotThrow(Local<String> property,
                                            const AccessorInfo &info) {
    HandleScope scope;
    Function *fun = ObjectWrap::Unwrap<Function>(info.This());
...
Handle<v8::Value> Function::GetDoesNotAccessMemory(Local<String> property,
                                                   const AccessorInfo &info) {
    HandleScope scope;
    Function *fun = ObjectWrap::Unwrap<Function>(info.This());
    Handle<v8::Value> result =
        Boolean::New(fun->llvm_fun->doesNotAccessMemory());
    return scope.Close(result);
}

Handle<v8::Value> Function::GetOnlyReadsMemory(Local<String> property,
                                               const AccessorInfo &info) {
    HandleScope scope;
    Function *fun = ObjectWrap::Unwrap<Function>(info.This());
