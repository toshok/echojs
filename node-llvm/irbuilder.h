...
class IRBuilder : public node::ObjectWrap {
  ...
  private:
    ...
    SetInsertPointStartBB(const v8::Arguments &args);
    ...
    static v8::Handle<v8::Value>
    CreateExtractElement(const v8::Arguments &args);
    static v8::Handle<v8::Value> CreateExtractValue(const v8::Arguments &args);
    static v8::Handle<v8::Value>
    CreateGetElementPointer(const v8::Arguments &args);
    static v8::Handle<v8::Value>
    CreateInBoundsGetElementPointer(const v8::Arguments &args);
    static v8::Handle<v8::Value>
    CreateStructGetElementPointer(const v8::Arguments &args);
    ...
    static v8::Handle<v8::Value>
    CreateGlobalStringPtr(const v8::Arguments &args);
    ...
    static v8::Handle<v8::Value>
    GetCurrentDebugLocation(const v8::Arguments &args);
    static v8::Handle<v8::Value>
    SetCurrentDebugLocation(const v8::Arguments &args);
