...
void IRBuilder::Init(Handle<Object> target) {
    ...
    NODE_SET_METHOD(s_func, "setInsertPointStartBB",
                    IRBuilder::SetInsertPointStartBB);
    ...
    NODE_SET_METHOD(s_func, "createExtractElement",
                    IRBuilder::CreateExtractElement);
    NODE_SET_METHOD(s_func, "createExtractValue",
                    IRBuilder::CreateExtractValue);
    NODE_SET_METHOD(s_func, "createGetElementPointer",
                    IRBuilder::CreateGetElementPointer);
    NODE_SET_METHOD(s_func, "createInBoundsGetElementPointer",
                    IRBuilder::CreateInBoundsGetElementPointer);
    NODE_SET_METHOD(s_func, "createStructGetElementPointer",
                    IRBuilder::CreateStructGetElementPointer);
    ...
    NODE_SET_METHOD(s_func, "createICmpUGE", IRBuilder::CreateICmpUGE);
    ...
    NODE_SET_METHOD(s_func, "createGlobalStringPtr",
    ...
    NODE_SET_METHOD(s_func, "createLifetimeStart",
                    IRBuilder::CreateLifetimeStart);
    NODE_SET_METHOD(s_func, "createLifetimeEnd", IRBuilder::CreateLifetimeEnd);

    NODE_SET_METHOD(s_func, "getCurrentDebugLocation",
                    IRBuilder::GetCurrentDebugLocation);
    NODE_SET_METHOD(s_func, "setCurrentDebugLocation",
                    IRBuilder::SetCurrentDebugLocation);

    target->Set(String::NewSymbol("IRBuilder"), s_func);
}

v8::Handle<v8::Value> IRBuilder::New(const v8::Arguments &args) {
    return ThrowException(Exception::Error(
        String::New("IRBuilder is not meant to be instantiated.")));
}
...
v8::Handle<v8::Value>
IRBuilder::SetInsertPointStartBB(const v8::Arguments &args) {
    HandleScope scope;
    REQ_LLVM_BB_ARG(0, bb);
    if (bb != NULL)
...
v8::Handle<v8::Value> IRBuilder::CreateRet(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result = Instruction::New(
        static_cast<llvm::Instruction *>(builder.CreateRet(val)));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateRetVoid(const v8::Arguments &args) {
    HandleScope scope;
    Handle<v8::Value> result = Instruction::New(
        static_cast<llvm::Instruction *>(builder.CreateRetVoid()));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreatePointerCast(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result =
        Instruction::New(static_cast<llvm::Instruction *>(
            builder.CreatePointerCast(val, ty, *name)));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateFPCast(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result = Instruction::New(
        static_cast<llvm::Instruction *>(builder.CreateFPCast(val, ty, *name)));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateUnreachable(const v8::Arguments &args) {
    HandleScope scope;
    Handle<v8::Value> result = Instruction::New(
        static_cast<llvm::Instruction *>(builder.CreateUnreachable()));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateAnd(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result = Instruction::New(
        static_cast<llvm::Instruction *>(builder.CreateAnd(lhs, rhs, *name)));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateOr(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result = Instruction::New(
        static_cast<llvm::Instruction *>(builder.CreateOr(lhs, rhs, *name)));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateZExt(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result =
        Instruction::New(static_cast<llvm::Instruction *>(
            builder.CreateZExt(V, dest_ty, *name)));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateIntToPtr(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result =
        Instruction::New(static_cast<llvm::Instruction *>(
            builder.CreateIntToPtr(V, dest_ty, *name)));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreatePtrToInt(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result =
        Instruction::New(static_cast<llvm::Instruction *>(
            builder.CreatePtrToInt(V, dest_ty, *name)));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateBitCast(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result =
        Instruction::New(static_cast<llvm::Instruction *>(
            builder.CreateBitCast(V, dest_ty, *name)));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateCall(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result =
        Call::New(IRBuilder::builder.CreateCall(callee, ArgsV, *name));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateInvoke(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result = Invoke::New(IRBuilder::builder.CreateInvoke(
        callee, normal_dest, unwind_dest, ArgsV, *name));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateFAdd(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result =
        Instruction::New(static_cast<llvm::Instruction *>(
            IRBuilder::builder.CreateFAdd(left, right, *name)));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateAlloca(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result =
        AllocaInst::New(IRBuilder::builder.CreateAlloca(ty, 0, *name));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateLoad(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result =
        LoadInst::New(IRBuilder::builder.CreateLoad(val, *name));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateStore(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result =
        Instruction::New(static_cast<llvm::Instruction *>(
            IRBuilder::builder.CreateStore(val, ptr)));
    return scope.Close(result);
}

v8::Handle<v8::Value>
IRBuilder::CreateExtractElement(const v8::Arguments &args) {
    HandleScope scope;
    ...
    Handle<v8::Value> result =
        Instruction::New(static_cast<llvm::Instruction *>(
            IRBuilder::builder.CreateExtractElement(val, idx, *name)));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateExtractValue(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result =
        Instruction::New(static_cast<llvm::Instruction *>(
            IRBuilder::builder.CreateExtractValue(val, idx, *name)));
    return scope.Close(result);
}

v8::Handle<v8::Value>
IRBuilder::CreateGetElementPointer(const v8::Arguments &args) {
    HandleScope scope;
    ...
    Handle<v8::Value> result =
        Instruction::New(static_cast<llvm::Instruction *>(
            IRBuilder::builder.CreateGEP(val, IdxV, *name)));
    return scope.Close(result);
}

v8::Handle<v8::Value>
IRBuilder::CreateInBoundsGetElementPointer(const v8::Arguments &args) {
    HandleScope scope;
    ...
    Handle<v8::Value> result =
        Instruction::New(static_cast<llvm::Instruction *>(
            IRBuilder::builder.CreateInBoundsGEP(val, IdxV, *name)));
    return scope.Close(result);
}

v8::Handle<v8::Value>
IRBuilder::CreateStructGetElementPointer(const v8::Arguments &args) {
    HandleScope scope;
    ...
    Handle<v8::Value> result =
        Instruction::New(static_cast<llvm::Instruction *>(
            IRBuilder::builder.CreateStructGEP(val, idx, *name)));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateICmpEq(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result =
        Instruction::New(static_cast<llvm::Instruction *>(
            IRBuilder::builder.CreateICmpEQ(left, right, *name)));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateICmpSGt(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result =
        Instruction::New(static_cast<llvm::Instruction *>(
            IRBuilder::builder.CreateICmpSGT(left, right, *name)));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateICmpUGt(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result =
        Instruction::New(static_cast<llvm::Instruction *>(
            IRBuilder::builder.CreateICmpUGT(left, right, *name)));
    return scope.Close(result);
}

v8::Handle<v8::Value> IRBuilder::CreateICmpUGE(const v8::Arguments &args) {
    HandleScope scope;
    ...
    Handle<v8::Value> result =
        Instruction::New(static_cast<llvm::Instruction *>(
            IRBuilder::builder.CreateICmpUGE(left, right, *name)));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateICmpULt(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result =
        Instruction::New(static_cast<llvm::Instruction *>(
            IRBuilder::builder.CreateICmpULT(left, right, *name)));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateBr(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result = Instruction::New(
        static_cast<llvm::Instruction *>(IRBuilder::builder.CreateBr(dest)));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateCondBr(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result =
        Instruction::New(static_cast<llvm::Instruction *>(
            IRBuilder::builder.CreateCondBr(cond, thenPart, elsePart)));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreatePhi(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result =
        Instruction::New(static_cast<llvm::Instruction *>(
            IRBuilder::builder.CreatePHI(ty, incoming_values, *name)));
    return scope.Close(result);
}

v8::Handle<v8::Value>
IRBuilder::CreateGlobalStringPtr(const v8::Arguments &args) {
    HandleScope scope;
    ...
    Handle<v8::Value> result =
        Instruction::New(static_cast<llvm::Instruction *>(
            IRBuilder::builder.CreateGlobalStringPtr(*val, *name)));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateSwitch(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result =
        Switch::New(IRBuilder::builder.CreateSwitch(V, Dest, num_cases));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateSelect(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result =
        Instruction::New(static_cast<llvm::Instruction *>(
            IRBuilder::builder.CreateSelect(C, True, False, *name)));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateNswSub(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result =
        Instruction::New(static_cast<llvm::Instruction *>(
            IRBuilder::builder.CreateNSWSub(lhs, rhs, *name)));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateLandingPad(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result = LandingPad::New(
        IRBuilder::builder.CreateLandingPad(ty, persFn, num_clauses, *name));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateResume(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result = Instruction::New(
        static_cast<llvm::Instruction *>(IRBuilder::builder.CreateResume(val)));
    return scope.Close(result);
}

v8::Handle<v8::Value>
IRBuilder::CreateLifetimeStart(const v8::Arguments &args) {
    HandleScope scope;
    ...
    Handle<v8::Value> result =
        Instruction::New(static_cast<llvm::Instruction *>(
            IRBuilder::builder.CreateLifetimeStart(val, size)));
    return scope.Close(result);
}
...
v8::Handle<v8::Value> IRBuilder::CreateLifetimeEnd(const v8::Arguments &args) {
    ...
    Handle<v8::Value> result =
        Instruction::New(static_cast<llvm::Instruction *>(
            IRBuilder::builder.CreateLifetimeEnd(val, size)));
    return scope.Close(result);
}

v8::Handle<v8::Value>
IRBuilder::GetCurrentDebugLocation(const v8::Arguments &args) {
    HandleScope scope;

    Handle<v8::Value> result =
        DebugLoc::New(IRBuilder::builder.getCurrentDebugLocation());
    return scope.Close(result);
}

v8::Handle<v8::Value>
IRBuilder::SetCurrentDebugLocation(const v8::Arguments &args) {
    HandleScope scope;
