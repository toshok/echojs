...
void Module::Init(Handle<Object> target) {
    ...
    NODE_SET_PROTOTYPE_METHOD(s_ct, "getGlobalVariable",
                              Module::GetGlobalVariable);
    NODE_SET_PROTOTYPE_METHOD(s_ct, "getOrInsertIntrinsic",
                              Module::GetOrInsertIntrinsic);
    NODE_SET_PROTOTYPE_METHOD(s_ct, "getOrInsertFunction",
                              Module::GetOrInsertFunction);
    NODE_SET_PROTOTYPE_METHOD(s_ct, "getOrInsertGlobal",
                              Module::GetOrInsertGlobal);
    NODE_SET_PROTOTYPE_METHOD(s_ct, "getOrInsertExternalFunction",
                              Module::GetOrInsertExternalFunction);
    ...
    NODE_SET_PROTOTYPE_METHOD(s_ct, "writeBitcodeToFile",
                              Module::WriteBitcodeToFile);
    ...
    target->Set(String::NewSymbol("Module"), s_func);
}
...
Handle<v8::Value> Module::New(const Arguments &args) {
    ...
    if (args.Length()) {
        ...
        llvm::Module *llvm_module =
            new llvm::Module(*name, llvm::getGlobalContext());
...
#endif
            llvm_module->addModuleFlag(llvm::Module::Warning, "Dwarf Version",
                                       2);
...
Handle<v8::Value> Module::GetGlobalVariable(const Arguments &args) {
    ...
    return scope.Close(GlobalVariable::New(
...
Handle<v8::Value> Module::GetOrInsertGlobal(const Arguments &args) {
    ...
    return scope.Close(GlobalVariable::New(static_cast<llvm::GlobalVariable *>(
