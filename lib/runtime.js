...
const runtime_interface = {
    ...
    create_iter_result:    function() { return this.abi.createExternalFunction(this.module, "_ejs_create_iter_result", types.EjsValue, [types.EjsValue, types.EjsValue]); },

    iterator_wrapper_new:  function() { return this.abi.createExternalFunction(this.module, "_ejs_iterator_wrapper_new", types.EjsValue, [types.EjsValue]); },
