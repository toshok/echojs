...
import * as b, { Literal, Identifier, MemberExpression, ComputedPropertyKey,
                 FunctionDeclaration, ClassDeclaration, VariableDeclaration,
                 VariableDeclarator, BlockStatement } from './ast-builder';
...
class LLVMIRVisitor extends TreeVisitor {
    ...
    visitArgsForConstruct (callee, args) {
        ...
        this.doInsideBBlock (invalid_obj_bb, () => {
            this.emitThrowNativeError (5, "return value from @@create is not an object"); // this '5' should be 'EJS_TYPE_ERROR'
        });
    ...
    visitArrayExpression (n) {
        let obj = this.createCall(this.ejs_runtime.array_new, [consts.int32(n.elements.length), consts.False()], "arrtmp", !this.ejs_runtime.array_new.doesNotThrow);
        let i = 0;
    ...
    handleModuleGetExotic (exp, opencode) {
        ...
        return this.createCall(this.ejs_runtime.module_get, [moduleString], "get_module_exotic");
    }
...
export function compile (tree, base_output_filename, source_filename, module_infos, options) {
    ...
    this_module_info.exports.forEach ((export_info, key) => {
        ...
        if (module_prop.getter || module_prop.setter)
