...
const BUILTIN_ARGS = [
  { name: EJS_CONTEXT_NAME, type: llvm.LLVMType.EjsContextType },
  { name: EJS_THIS_NAME,    type: llvm.LLVMType.EjsValueType },
  { name: EJS_ENV,          type: llvm.LLVMType.EjsValueType }
];
...
function NodeVisitor(module) {
  ...
  this.ejs = {
    invoke_closure: [
      ffi_c(module.getOrInsertExternalFunction("_ejs_invoke_closure_0", llvm.LLVMType.EjsValueType, llvm.LLVMType.EjsContextType, llvm.LLVMType.EjsValueType, llvm.LLVMType.int32Type)),
      ffi_c(module.getOrInsertExternalFunction("_ejs_invoke_closure_1", llvm.LLVMType.EjsValueType, llvm.LLVMType.EjsContextType, llvm.LLVMType.EjsValueType, llvm.LLVMType.int32Type, llvm.LLVMType.EjsValueType)),
      ffi_c(module.getOrInsertExternalFunction("_ejs_invoke_closure_2", llvm.LLVMType.EjsValueType, llvm.LLVMType.EjsContextType, llvm.LLVMType.EjsValueType, llvm.LLVMType.int32Type, llvm.LLVMType.EjsValueType, llvm.LLVMType.EjsValueType)),
      ffi_c(module.getOrInsertExternalFunction("_ejs_invoke_closure_3", llvm.LLVMType.EjsValueType, llvm.LLVMType.EjsContextType, llvm.LLVMType.EjsValueType, llvm.LLVMType.int32Type, llvm.LLVMType.EjsValueType, llvm.LLVMType.EjsValueType, llvm.LLVMType.EjsValueType))
    ],
