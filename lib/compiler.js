...
class LLVMIRVisitor extends TreeVisitor {
    ...
    emitModuleInfo() {
        let this_module_type = types.getModuleSpecificType(
        ...
        this.this_module_global = new llvm.GlobalVariable(
            ...
            this_module_type,
            this.this_module_info.module_name,
            llvm.Constant.getAggregateZero(this_module_type),
            true
        );
    ...
    visitIfOrCondExp(n, load_result) {
        ...
        ir.setInsertPoint(merge_bb);
        if (load_result) return this.createLoad(cond_val, "cond_val_load");
...
*/
    ...
    visitThisExpression() {
        ...
        return this.createLoad(
            this.createLoad(this.findIdentifierInScope("%this"), "load_this_ptr"),
            "load_this"
        );
    }
                ...
                if (this.currentFunction.returnValueAlloca) {
                    ...
                    this.doInsideBBlock(return_tramp, () => {
                        if (this.finallyStack.length > 0) {
                            ...
                            this.createRet(
                                this.createLoad(this.currentFunction.returnValueAlloca, "rv")
                            );
                        }
                    });
                }
