...
class LLVMIRVisitor extends TreeVisitor {
    ...
    visitFunction (n) {
        ...
        if (n.toplevel) {
            ...
            console.log(`set toplevel function to ${this.toplevel_function}`);
    ...
    visitObjectExpression (n) {
        ...
        accessor_map.forEach ((prop_map, propkey) => {
            ...
            if (propkey.type === b.ComputedPropertyKey)
...
class AddFunctionsVisitor extends TreeVisitor {
    ...
    visitFunction (n) {
        ...
        if (this.dibuilder && this.difile)
            n.ir_func.debug_info = this.dibuilder.createFunction(this.difile, n.ir_name, n.ir_name, this.difile, lineno, false, true, lineno, 0, true, n.ir_func);
