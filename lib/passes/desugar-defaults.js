...
export class DesugarDefaults extends TransformPass {
    ...
    visitFunction (n) {
        ...
        n.params.forEach((p, i) => {
            ...
            prepends.push(b.letDeclaration(p, b.conditionalExpression(intrinsic(argPresent_id, [b.literal(i+1), b.literal(n.defaults[i] != null)]), intrinsic(getArg_id, [b.literal(i)]), d)));
	});
