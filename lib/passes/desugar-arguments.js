...
import { Identifier, ComputedPropertyKey }, * as b from '../ast-builder';

const getArgumentsObject_id = b.identifier("%getArgumentsObject");
...
export class DesugarArguments extends TransformPass {
    ...
    visitAssignmentExpression(n) {
        if (n.left.type === Identifier && n.left.name === "arguments")
