...
import { typeofIsObject_id, typeofIsFunction_id, typeofIsString_id, typeofIsSymbol_id, typeofIsNumber_id, typeofIsBoolean_id, isNull_id, isUndefined_id } from '../common-ids';
module b from '../ast-builder';
import { Literal, UnaryExpression } from '../ast-builder';
import { create_intrinsic } from '../echo-util';
import { TreeVisitor } from '../node-visitor';

function is_typeof(e) { return e.type === UnaryExpression && e.operator === "typeof"; }
function is_string_literal(e) { return e.type === Literal && typeof e.value === "string"; }
function is_undefined_literal(e) { return e.type === Literal && e.value === undefined; }
function is_null_literal(e) { return e.type === Literal && e.value === null; }
