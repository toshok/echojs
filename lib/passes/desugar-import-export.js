...
import { ExportBatchSpecifier, FunctionDeclaration, ClassDeclaration, VariableDeclaration, VariableDeclarator } from '../ast-builder';
...
export class DesugarImportExport extends TransformPass {
    ...
    visitExportDeclaration (n) {
        ...
        // export default = ...;
        // 
        if (Array.isArray(n.declaration) && n.declaration[0].id.name === "default") {
            let local_default_id = b.identifier("%default");
            let default_id = b.identifier("default");
            this.exports.push({ id: default_id });
            
            let local_decl = b.varDeclaration(local_default_id, n.declaration[0].init);
