...
export class IIFEIdioms extends TransformPass {
    ...
    visitExpressionStatement (n) {
        let isMakeClosure = (a) => is_intrinsic(a, "%makeClosure") || is_intrinsic(a, "%makeAnonClosure") || is_intrinsic(a, "%makeClosureNoEnv");
        ...
        else if (candidate.arguments[0].type === b.MemberExpression && isMakeClosure(candidate.arguments[0].object) && candidate.arguments[0].property.name === "call") {
