...
import { superid, setPrototypeOf_id, objectCreate_id } from '../common-ids';
...
export class DesugarClasses extends TransformPass {
    ...
    generateClassIIFE (n) {
        ...
        class_init_iife_body.unshift(b.expressionStatement(b.assignmentExpression(b.memberExpression(b.memberExpression(superid, b.identifier("prototype")), b.identifier("constructor")), "=", n.id)));
    ...
    create_default_constructor (ast_class) {
        ...
        return b.methodDefinition(b.identifier('constructor'), b.functionExpression(null, [], functionBody, [], args_id));
    }
