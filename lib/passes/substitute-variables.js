...
import { ComputedPropertyKey, CallExpression, FunctionDeclaration, Identifier, NewExpression } from '../ast-builder';
    ...
    visitFunction (n) {
        try {
            ...
            if (n.ejs_env.closed.empty() && !n.ejs_env.nested_requires_env) {
                ...
                let flatten_memberexp = (exp, mapping) => {
