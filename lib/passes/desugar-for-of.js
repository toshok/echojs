...
import * as b, { VariableDeclaration } from '../ast-builder';
...
export class DesugarForOf extends TransformPass {
    ...
    visitForOf (n) {
        ...
        if (n.left.type === VariableDeclaration)
            ...
            loop_iter_stmt = b.expressionStatement(b.assignmentExpression(n.left, "=", b.memberExpression(iter_next_id, value_id)));

        let next_decl = b.letDeclaration(iter_next_id, b.undefinedLit());

        let not_done = b.unaryExpression("!", b.memberExpression(b.assignmentExpression(iter_next_id, "=", b.callExpression(b.memberExpression(iter_id, next_id))), done_id));
