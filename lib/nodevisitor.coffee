...
exports.TreeVisitor = class TreeVisitor
        ...
        visit: (n, args...) ->
                ...
                switch n.type
                        ...
                        when ComputedPropertyKey     then rv = @visitComputedPropertyKey n, args...
                        when DebuggerStatement       then throw new Error "Unhandled AST node type: #{n.type}, #{JSON.stringify n}"
                        ...
                        when ExportBatchSpecifier    then throw new Error "Unhandled AST node type: #{n.type}, #{JSON.stringify n}"
                        when ExportSpecifier         then throw new Error "Unhandled AST node type: #{n.type}, #{JSON.stringify n}"
