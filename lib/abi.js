...
export class ABI {
    ...
    createCall(fromFunction, calleeType, callee, argv, callname) {
        // XXX this is wrong currently (createCall/createInvoke must take another arg (the function type)
        // new_llvm
    ...
    createFunction(inModule, name, ret_type, param_types) {
