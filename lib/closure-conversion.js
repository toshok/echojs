...
// AST.
//
// DesugarSpread also stays in the main list below: it skips super calls
// (this runs before DesugarClasses now), so the post-classes run picks up
// spreads remaining in rewritten super calls.
const pre_eir_passes = [DesugarSpread];
