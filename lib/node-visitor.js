...
export class TreeVisitor {
    ...
    visit (n, ...args) {
        ...
        case b.ComputedPropertyKey:          rv = this.visitComputedPropertyKey(n, ...args); break;
        ...
        case b.ExportDeclaration:            rv = this.visitExportDeclaration(n, ...args); break;
        case b.ExportBatchSpecifier:         throw new Error(`Unhandled AST node type: ${n.type}, ${JSON.stringify(n)}`);
        case b.ExportSpecifier:              throw new Error(`Unhandled AST node type: ${n.type}, ${JSON.stringify(n)}`);
