...
export class TreeVisitor {
    ...
    visit(n, ...args) {
        ...
        switch (n.type) {
            case b.ArrayExpression:
                rv = this.visitArrayExpression(n, ...args);
                break;
            case b.ArrayPattern:
                rv = this.visitArrayPattern(n, ...args);
                break;
            case b.ArrowFunctionExpression:
                rv = this.visitArrowFunctionExpression(n, ...args);
                break;
            case b.AssignmentExpression:
                rv = this.visitAssignmentExpression(n, ...args);
                break;
            case b.AssignmentPattern:
                rv = this.visitAssignmentPattern(n, ...args);
                break;
            case b.BinaryExpression:
                rv = this.visitBinaryExpression(n, ...args);
                break;
            case b.BlockStatement:
                rv = this.visitBlock(n, ...args);
                break;
            case b.BreakStatement:
                rv = this.visitBreak(n, ...args);
                break;
            case b.CallExpression:
                rv = this.visitCallExpression(n, ...args);
                break;
            case b.CatchClause:
                rv = this.visitCatchClause(n, ...args);
                break;
            case b.ClassBody:
                rv = this.visitClassBody(n, ...args);
                break;
            case b.ClassDeclaration:
                rv = this.visitClassDeclaration(n, ...args);
                break;
            case b.ClassExpression:
                rv = this.visitClassExpression(n, ...args);
                break;
            case b.ClassHeritage:
                throw new Error(`Unhandled AST node type: ${n.type}, ${JSON.stringify(n)}`);
            case b.ComprehensionBlock:
                throw new Error(`Unhandled AST node type: ${n.type}, ${JSON.stringify(n)}`);
            case b.ComprehensionExpression:
                throw new Error(`Unhandled AST node type: ${n.type}, ${JSON.stringify(n)}`);
            case b.ConditionalExpression:
                rv = this.visitConditionalExpression(n, ...args);
                break;
            case b.ContinueStatement:
                rv = this.visitContinue(n, ...args);
                break;
            case b.DebuggerStatement:
                rv = n; // compiled as a no-op
                break;
            case b.DoWhileStatement:
                rv = this.visitDo(n, ...args);
                break;
            case b.EmptyStatement:
                rv = this.visitEmptyStatement(n, ...args);
                break;
            case b.ExportNamedDeclaration:
                rv = this.visitExportNamedDeclaration(n, ...args);
                break; // XXX jquery esprima
            case b.ExportAllDeclaration:
                rv = this.visitExportAllDeclaration(n, ...args);
                break; // XXX jquery esprima
            case b.ExportDefaultDeclaration:
                rv = this.visitExportDefaultDeclaration(n, ...args);
                break; // XXX jquery esprima
            case b.ExpressionStatement:
                rv = this.visitExpressionStatement(n, ...args);
                break;
            case b.ForInStatement:
                rv = this.visitForIn(n, ...args);
                break;
            case b.ForOfStatement:
                rv = this.visitForOf(n, ...args);
                break;
            case b.ForStatement:
                rv = this.visitFor(n, ...args);
                break;
            case b.FunctionDeclaration:
                rv = this.visitFunctionDeclaration(n, ...args);
                break;
            case b.FunctionExpression:
                rv = this.visitFunctionExpression(n, ...args);
                break;
            case b.Identifier:
                rv = this.visitIdentifier(n, ...args);
                break;
            case b.IfStatement:
                rv = this.visitIf(n, ...args);
                break;
            case b.ImportDeclaration:
                rv = this.visitImportDeclaration(n, ...args);
                break;
            case b.ImportSpecifier:
                rv = this.visitImportSpecifier(n, ...args);
                break;
            case b.ImportDefaultSpecifier:
                rv = this.visitImportDefaultSpecifier(n, ...args);
                break;
            case b.ImportNamespaceSpecifier:
                rv = this.visitImportNamespaceSpecifier(n, ...args);
                break;
            case b.LabeledStatement:
                rv = this.visitLabeledStatement(n, ...args);
                break;
            case b.Literal:
                rv = this.visitLiteral(n, ...args);
                break;
            case b.LogicalExpression:
                rv = this.visitLogicalExpression(n, ...args);
                break;
            case b.MemberExpression:
                rv = this.visitMemberExpression(n, ...args);
                break;
            case b.MetaProperty:
                rv = this.visitMetaProperty(n, ...args);
                break;
            case b.MethodDefinition:
                rv = this.visitMethodDefinition(n, ...args);
                break;
            case b.ModuleDeclaration:
                rv = this.visitModuleDeclaration(n, ...args);
                break;
            case b.NewExpression:
                rv = this.visitNewExpression(n, ...args);
                break;
            case b.ObjectExpression:
                rv = this.visitObjectExpression(n, ...args);
                break;
            case b.ObjectPattern:
                rv = this.visitObjectPattern(n, ...args);
                break;
            case b.Program:
                rv = this.visitProgram(n, ...args);
                break;
            case b.Property:
                rv = this.visitProperty(n, ...args);
                break;
            case b.RestElement:
                rv = this.visitRestElement(n, ...args);
                break;
            case b.ReturnStatement:
                rv = this.visitReturn(n, ...args);
                break;
            case b.SequenceExpression:
                rv = this.visitSequenceExpression(n, ...args);
                break;
            case b.SpreadElement:
                rv = this.visitSpreadElement(n, ...args);
                break;
            case b.Super:
                rv = this.visitSuper(n, ...args);
                break;
            case b.SwitchCase:
                rv = this.visitCase(n, ...args);
                break;
            case b.SwitchStatement:
                rv = this.visitSwitch(n, ...args);
                break;
            case b.TaggedTemplateExpression:
                rv = this.visitTaggedTemplateExpression(n, ...args);
                break;
            case b.TemplateElement:
                rv = this.visitTemplateElement(n, ...args);
                break;
            case b.TemplateLiteral:
                rv = this.visitTemplateLiteral(n, ...args);
                break;
            case b.ThisExpression:
                rv = this.visitThisExpression(n, ...args);
                break;
            case b.ThrowStatement:
                rv = this.visitThrow(n, ...args);
                break;
            case b.TryStatement:
                rv = this.visitTry(n, ...args);
                break;
            case b.UnaryExpression:
                rv = this.visitUnaryExpression(n, ...args);
                break;
            case b.UpdateExpression:
                rv = this.visitUpdateExpression(n, ...args);
                break;
            case b.VariableDeclaration:
                rv = this.visitVariableDeclaration(n, ...args);
                break;
            case b.VariableDeclarator:
                rv = this.visitVariableDeclarator(n, ...args);
                break;
            case b.WhileStatement:
                rv = this.visitWhile(n, ...args);
                break;
            case b.WithStatement:
                rv = this.visitWith(n, ...args);
                break;
            case b.YieldExpression:
                rv = this.visitYield(n, ...args);
                break;
            default:
    ...
    visitTry(n, ...args) {
        ...
        if (n.handlers) n.handlers = this.visit(n.handlers, ...args);
        else n.handlers = null;
    ...
    visitMemberExpression(n, ...args) {
        n.object = this.visit(n.object, ...args);
        if (n.computed) n.property = this.visit(n.property, ...args);
        return n;
    }
    ...
    visitImportNamespaceSpecifier(n) {
        return n;
    }
