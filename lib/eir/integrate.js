...
//     back too.
// anything else (non-exported mutable module vars, non-exported siblings
// used as values, namespace/default imports, unsupported syntax) falls
// back per function via LowerNotSupported.
//
    ...
    if (module_infos) {
        for (let stmt of toplevelBody) {
            ...
            for (let spec of stmt.specifiers) {
                ...
                if (!module_info.exports.has(imported_name)) continue;
