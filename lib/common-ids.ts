...
export const generatorIsReturnSentinel_id = identifier("%generatorIsReturnSentinel");
export const generatorReturnValue_id = identifier("%generatorReturnValue");
...
export const constructClosure_id = identifier("%constructClosure");
export const constructSuper_id = identifier("%constructSuper");
export const constructSuperApply_id = identifier("%constructSuperApply");
export const constructApply_id = identifier("%constructApply");
...
export const getNewTarget_id = identifier("%getNewTarget");
...
export const copyDataProps_id = identifier("%copyDataProps");
export const requireObjectCoercible_id = identifier("%requireObjectCoercible");
export const objectSpreadMerge_id = identifier("%objectSpreadMerge");
export const defineField_id = identifier("%defineField");
export const makePrivateMap_id = identifier("%makePrivateMap");
export const privFieldGet_id = identifier("%privFieldGet");
export const privFieldSet_id = identifier("%privFieldSet");
export const privFieldInit_id = identifier("%privFieldInit");
export const privBrandCheck_id = identifier("%privBrandCheck");
export const privHas_id = identifier("%privHas");
export const privWriteError_id = identifier("%privWriteError");
export const getNextValue_id = identifier("getNextValue");
export const getRest_id = identifier("getRest");
export const close_id = identifier("close");
