...
export function functionDeclaration   (id, params, body, defaults=[]) { return { type: FunctionDeclaration, id: isast(id), params: params.map(isast), body: isast(body), defaults: defaults.map(isnullableast), generator: false, expression: false }; };
export function functionExpression    (id, params, body, defaults=[]) { return { type: FunctionExpression,  id: isnullableast(id), params: params.map(isast), body: isast(body), defaults: defaults.map(isnullableast), generator: false, expression: false }; };
...
export function memberExpression      (obj, prop, computed = false) { return { type: MemberExpression, object: isast(obj), property: isast(prop), computed: isboolean(computed) }; };
export function metaProperty          (meta, property) { return { type: MetaProperty, meta, property }; };
...
export function property              (key, value, kind = "init", computed = false) { return { type: Property, key: isast(key), value: isast(value), kind: kind, computed: isboolean(computed) }; };
export function restElement           (arg) { return { type: RestElement, argument: isast(arg) }; };
...
export function superExpression       () { return { type: Super }; };
