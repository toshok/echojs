...
export let methodDefinition   = (key, value, kind = "init") => ({ type: MethodDefinition, key: key, value: value, kind: kind });
...
export let spreadElement    = (arg) => ({ type: SpreadElement, argument: arg });
