...
export function arrowFunctionExpression (params, body, defaults=[], rest=null, expression=false) { return { type: ArrowFunctionExpression, params: params.map(isast), defaults: defaults.map(isast), rest: isnullableast(rest), body: isast(body), expression: expression }; };
