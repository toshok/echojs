...
export let functionDeclaration = (id, params, body, defaults=[], rest=null) => ({ type: FunctionDeclaration, id: isast(id), params: params.map(isast), body: isast(body), defaults: defaults.map(isast), rest: isnullableast(rest), generator: false, expression: false });
export let functionExpression  = (id, params, body, defaults=[], rest=null) => ({ type: FunctionExpression,  id: isnullableast(id), params: params.map(isast), body: isast(body), defaults: defaults.map(isast), rest: isnullableast(rest), generator: false, expression: false });
