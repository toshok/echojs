...
export function continueStatement       (label)                       { return { type: ContinueStatement, label: isast(label) }; }
...
export function ifStatement (test, consequent, alternate) { return { type: IfStatement, test: isast(test), consequent: isast(consequent), alternate: isast(alternate) }; }
