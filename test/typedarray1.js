...
dumpStuff (new Int8Array(new ArrayBuffer(arrayBufferSize), offsetElements * Int8Array.BYTES_PER_ELEMENT));
...
dumpStuff (new Uint8Array(new ArrayBuffer(arrayBufferSize), offsetElements * Uint8Array.BYTES_PER_ELEMENT));
...
dumpStuff (new Int16Array(new ArrayBuffer(arrayBufferSize), offsetElements * Int16Array.BYTES_PER_ELEMENT));
...
dumpStuff (new Uint16Array(new ArrayBuffer(arrayBufferSize), offsetElements * Uint16Array.BYTES_PER_ELEMENT));
...
dumpStuff (new Int32Array(new ArrayBuffer(arrayBufferSize), offsetElements * Int32Array.BYTES_PER_ELEMENT));
...
dumpStuff (new Uint32Array(new ArrayBuffer(arrayBufferSize), offsetElements * Uint32Array.BYTES_PER_ELEMENT));
...
dumpStuff (new Float32Array(new ArrayBuffer(arrayBufferSize), offsetElements * Float32Array.BYTES_PER_ELEMENT));
...
dumpStuff (new Float64Array(new ArrayBuffer(arrayBufferSize), offsetElements * Float64Array.BYTES_PER_ELEMENT));
