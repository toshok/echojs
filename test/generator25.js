// gc-plan P0: NESTED active generators — the collector must cover the
// whole stack chain: the running stack, each suspended parent generator's
// segment, and the suspended main-stack segment behind the outermost
// resume site.
