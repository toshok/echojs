...
console.log(Int16Array.of().some(isGreaterThanTen));                // false
console.log(Int16Array.of(1, 3, 7).some(isGreaterThanTen));         // false
console.log(Int16Array.of(9, 10, 11).some(isGreaterThanTen));       // true
console.log(Int16Array.of(11, 11, 13).some(isGreaterThanTen));      // true
console.log();
...
console.log(Int16Array.of().some(isGreaterThanValue, obj));             // false
console.log(Int16Array.of(1, 3, 7).some(isGreaterThanValue, obj));      // false
console.log(Int16Array.of(7).some(isGreaterThanValue, obj));            // false
console.log(Int16Array.of(8).some(isGreaterThanValue, obj));            // true
console.log(Int16Array.of(11, 13, 17).some(isGreaterThanValue, obj));   // true
console.log(Int16Array.of(128, 133, -1).some(isGreaterThanValue, obj)); // true
