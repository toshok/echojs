...
// ECMA262: 15.8.2.1
static ejsval _ejs_Math_abs(ejsval env, ejsval _this, uint32_t argc,
                            ejsval *args) {
...
// ECMA262: 15.8.2.2
static ejsval _ejs_Math_acos(ejsval env, ejsval _this, uint32_t argc,
                             ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
// ECMA262: 15.8.2.3
static ejsval _ejs_Math_asin(ejsval env, ejsval _this, uint32_t argc,
                             ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
// ECMA262: 15.8.2.4
static ejsval _ejs_Math_atan(ejsval env, ejsval _this, uint32_t argc,
                             ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
// ECMA262: 15.8.2.5
static ejsval _ejs_Math_atan2(ejsval env, ejsval _this, uint32_t argc,
                              ejsval *args) {
...
// ECMA262: 15.8.2.6
static ejsval _ejs_Math_ceil(ejsval env, ejsval _this, uint32_t argc,
                             ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
// ECMA262: 15.8.2.7
static ejsval _ejs_Math_cos(ejsval env, ejsval _this, uint32_t argc,
                            ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
// ECMA262: 15.8.2.8
static ejsval _ejs_Math_exp(ejsval env, ejsval _this, uint32_t argc,
                            ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
// ECMA262: 15.8.2.9
static ejsval _ejs_Math_floor(ejsval env, ejsval _this, uint32_t argc,
                              ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
// ECMA262: 15.8.2.10
static ejsval _ejs_Math_log(ejsval env, ejsval _this, uint32_t argc,
                            ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
// ECMA262: 15.8.2.11
static ejsval _ejs_Math_max(ejsval env, ejsval _this, uint32_t argc,
                            ejsval *args) {
...
// ECMA262: 15.8.2.12
static ejsval _ejs_Math_min(ejsval env, ejsval _this, uint32_t argc,
                            ejsval *args) {
...
// ECMA262: 15.8.2.13
static ejsval _ejs_Math_pow(ejsval env, ejsval _this, uint32_t argc,
                            ejsval *args) {
    ejsval x = _ejs_undefined;
    ejsval y = _ejs_undefined;
    if (argc > 0)
...
// ECMA262: 15.8.2.14
static ejsval _ejs_Math_random(ejsval env, ejsval _this, uint32_t argc,
                               ejsval *args) {
    return NUMBER_TO_EJSVAL((double)rand() / RAND_MAX);
}

// ECMA262: 15.8.2.15
static ejsval _ejs_Math_round(ejsval env, ejsval _this, uint32_t argc,
                              ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
// ECMA262: 15.8.2.16
static ejsval _ejs_Math_sin(ejsval env, ejsval _this, uint32_t argc,
                            ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
// ECMA262: 15.8.2.17
static ejsval _ejs_Math_sqrt(ejsval env, ejsval _this, uint32_t argc,
                             ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
// ECMA262: 15.8.2.18
static ejsval _ejs_Math_tan(ejsval env, ejsval _this, uint32_t argc,
                            ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
static ejsval _ejs_Math_clz32(ejsval env, ejsval _this, uint32_t argc,
                              ejsval *args) {
...
static ejsval _ejs_Math_imul(ejsval env, ejsval _this, uint32_t argc,
                             ejsval *args) {
    if (argc != 2)
        return NUMBER_TO_EJSVAL(0);

    // When the Math.imul is called with arguments x and y the following steps
    // are taken:
...
// zero.
static ejsval _ejs_Math_sign(ejsval env, ejsval _this, uint32_t argc,
                             ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
static ejsval _ejs_Math_log10(ejsval env, ejsval _this, uint32_t argc,
                              ejsval *args) {
...
static ejsval _ejs_Math_log2(ejsval env, ejsval _this, uint32_t argc,
                             ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
static ejsval _ejs_Math_log1p(ejsval env, ejsval _this, uint32_t argc,
                              ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
static ejsval _ejs_Math_expm1(ejsval env, ejsval _this, uint32_t argc,
                              ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
static ejsval _ejs_Math_cosh(ejsval env, ejsval _this, uint32_t argc,
                             ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
static ejsval _ejs_Math_sinh(ejsval env, ejsval _this, uint32_t argc,
                             ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
static ejsval _ejs_Math_tanh(ejsval env, ejsval _this, uint32_t argc,
                             ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
static ejsval _ejs_Math_acosh(ejsval env, ejsval _this, uint32_t argc,
                              ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
static ejsval _ejs_Math_asinh(ejsval env, ejsval _this, uint32_t argc,
                              ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
static ejsval _ejs_Math_atanh(ejsval env, ejsval _this, uint32_t argc,
                              ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
static ejsval _ejs_Math_hypot(ejsval env, ejsval _this, uint32_t argc,
                              ejsval *args) {
    if (argc == 0)
        return NUMBER_TO_EJSVAL(0);
...
static ejsval _ejs_Math_trunc(ejsval env, ejsval _this, uint32_t argc,
                              ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
static ejsval _ejs_Math_fround(ejsval env, ejsval _this, uint32_t argc,
                               ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
static ejsval _ejs_Math_cbrt(ejsval env, ejsval _this, uint32_t argc,
                             ejsval *args) {
    ejsval x = _ejs_undefined;
    if (argc > 0)
        x = args[0];
...
#define OBJ_METHOD_LEN(x, l)                                                   \
    EJS_INSTALL_ATOM_FUNCTION_LEN_FLAGS(_ejs_Math, x, _ejs_Math_##x, l, 0)
...
#undef OBJ_METHOD
    ...
    _ejs_object_define_value_property(
        _ejs_Math, _ejs_Symbol_toStringTag, _ejs_atom_Math,
