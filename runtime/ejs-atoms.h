...
EJS_ATOM(getOwnPropertyDescriptors)
...
EJS_ATOM2(Symbol.asyncIterator,Symbol_asyncIterator)
...
EJS_ATOM(BigInt64Array)
EJS_ATOM(BigUint64Array)
EJS_ATOM(getBigInt64)
EJS_ATOM(setBigInt64)
EJS_ATOM(getBigUint64)
EJS_ATOM(setBigUint64)

EJS_ATOM(findLastIndex)
EJS_ATOM(toReversed)
EJS_ATOM(toSorted)
EJS_ATOM(toSpliced)
EJS_ATOM(with)
...
EJS_ATOM(union)
EJS_ATOM(intersection)
EJS_ATOM(difference)
EJS_ATOM(symmetricDifference)
EJS_ATOM(isSubsetOf)
EJS_ATOM(isSupersetOf)
EJS_ATOM(isDisjointFrom)

// Date
EJS_ATOM(UTC)
EJS_ATOM(getFullYear)
EJS_ATOM(getMonth)
EJS_ATOM(getDate)
EJS_ATOM(getDay)
EJS_ATOM(getHours)
EJS_ATOM(getMinutes)
EJS_ATOM(getSeconds)
EJS_ATOM(getMilliseconds)
EJS_ATOM(getUTCFullYear)
EJS_ATOM(getUTCMonth)
EJS_ATOM(getUTCDate)
EJS_ATOM(getUTCDay)
EJS_ATOM(getUTCHours)
EJS_ATOM(getUTCMinutes)
EJS_ATOM(getUTCSeconds)
EJS_ATOM(getUTCMilliseconds)
EJS_ATOM(setTime)
EJS_ATOM(setMilliseconds)
EJS_ATOM(setSeconds)
EJS_ATOM(setMinutes)
EJS_ATOM(setHours)
EJS_ATOM(setDate)
EJS_ATOM(setMonth)
EJS_ATOM(setFullYear)
EJS_ATOM(setUTCMilliseconds)
EJS_ATOM(setUTCSeconds)
EJS_ATOM(setUTCMinutes)
EJS_ATOM(setUTCHours)
EJS_ATOM(setUTCDate)
EJS_ATOM(setUTCMonth)
EJS_ATOM(setUTCFullYear)
EJS_ATOM(toISOString)
EJS_ATOM(toUTCString)
EJS_ATOM(toGMTString)
EJS_ATOM(toDateString)
EJS_ATOM(toTimeString)
EJS_ATOM(toLocaleDateString)
EJS_ATOM(toLocaleTimeString)
EJS_ATOM(getYear)
EJS_ATOM(setYear)

// explicit resource management + weak refs
EJS_ATOM(DisposableStack)
EJS_ATOM(AsyncDisposableStack)
EJS_ATOM(SuppressedError)
EJS_ATOM(FinalizationRegistry)
EJS_ATOM(WeakRef)
EJS_ATOM(dispose)
EJS_ATOM(asyncDispose)
EJS_ATOM2(Symbol.dispose,Symbol_dispose)
EJS_ATOM2(Symbol.asyncDispose,Symbol_asyncDispose)
EJS_ATOM(use)
EJS_ATOM(adopt)
EJS_ATOM(defer)
EJS_ATOM(move)
EJS_ATOM(disposed)
EJS_ATOM(disposeAsync)
EJS_ATOM(deref)
EJS_ATOM(register)
EJS_ATOM(unregister)
EJS_ATOM(cleanupSome)
EJS_ATOM(suppressed)
EJS_ATOM(SharedArrayBuffer)
EJS_ATOM(Atomics)
EJS_ATOM(grow)
EJS_ATOM(growable)
EJS_ATOM(maxByteLength)
EJS_ATOM(and)
EJS_ATOM(compareExchange)
EJS_ATOM(exchange)
EJS_ATOM(isLockFree)
EJS_ATOM(load)
EJS_ATOM(notify)
...
EJS_ATOM(xor)
EJS_ATOM(async)
EJS_ATOM2(not-equal,not_equal)
EJS_ATOM2(timed-out,timed_out)
EJS_ATOM(Iterator)
EJS_ATOM(take)
EJS_ATOM(drop)
EJS_ATOM(toArray)
EJS_ATOM(chunks)
EJS_ATOM(windows)
EJS_ATOM2(Iterator Helper,IteratorHelper)
EJS_ATOM(isError)
EJS_ATOM(cause)
EJS_ATOM(getOrInsert)
EJS_ATOM(getOrInsertComputed)
EJS_ATOM(groupBy)
EJS_ATOM(isWellFormed)
EJS_ATOM(toWellFormed)
EJS_ATOM(f16round)
EJS_ATOM(sumPrecise)
EJS_ATOM(rawJSON)
EJS_ATOM(isRawJSON)
EJS_ATOM(WeakMapSymbolData)
EJS_ATOM(LN10)
EJS_ATOM(LN2)
EJS_ATOM(LOG10E)
EJS_ATOM(LOG2E)
