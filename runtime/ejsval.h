...
static EJS_ALWAYS_INLINE EJSBool EJSDOUBLE_IS_NEGZERO(double d) {
    union {
        struct {
...
static EJS_ALWAYS_INLINE EJSBool EJSDOUBLE_IS_INT32(double d, int32_t *pi) {
...
EJS_ENUM_HEADER(EJSValueType, uint8_t) {
    EJSVAL_TYPE_DOUBLE = 0x00, EJSVAL_TYPE_INT32 = 0x01,
    EJSVAL_TYPE_UNDEFINED = 0x02, EJSVAL_TYPE_BOOLEAN = 0x03,
    EJSVAL_TYPE_MAGIC = 0x04, EJSVAL_TYPE_STRING = 0x05,
    EJSVAL_TYPE_CLOSUREENV = 0x06, EJSVAL_TYPE_NULL = 0x07,
    EJSVAL_TYPE_OBJECT = 0x08,

    /* These never appear in a ejsval; they are only provided as an out-of-band
       value. */
        EJSVAL_TYPE_UNKNOWN = 0x20, EJSVAL_TYPE_MISSING = 0x21
}
...
EJS_ENUM_HEADER(EJSValueShiftedTag, uint64_t) {
    EJSVAL_SHIFTED_TAG_MAX_DOUBLE =
        ((((uint64_t)EJSVAL_TAG_MAX_DOUBLE) << EJSVAL_TAG_SHIFT) | 0xFFFFFFFF),
    EJSVAL_SHIFTED_TAG_INT32 =
        (((uint64_t)EJSVAL_TAG_INT32) << EJSVAL_TAG_SHIFT),
    EJSVAL_SHIFTED_TAG_UNDEFINED =
        (((uint64_t)EJSVAL_TAG_UNDEFINED) << EJSVAL_TAG_SHIFT),
    EJSVAL_SHIFTED_TAG_STRING =
        (((uint64_t)EJSVAL_TAG_STRING) << EJSVAL_TAG_SHIFT),
    EJSVAL_SHIFTED_TAG_CLOSUREENV =
        (((uint64_t)EJSVAL_TAG_CLOSUREENV) << EJSVAL_TAG_SHIFT),
    EJSVAL_SHIFTED_TAG_BOOLEAN =
        (((uint64_t)EJSVAL_TAG_BOOLEAN) << EJSVAL_TAG_SHIFT),
    EJSVAL_SHIFTED_TAG_MAGIC =
        (((uint64_t)EJSVAL_TAG_MAGIC) << EJSVAL_TAG_SHIFT),
    EJSVAL_SHIFTED_TAG_NULL = (((uint64_t)EJSVAL_TAG_NULL) << EJSVAL_TAG_SHIFT),
    EJSVAL_SHIFTED_TAG_OBJECT =
        (((uint64_t)EJSVAL_TAG_OBJECT) << EJSVAL_TAG_SHIFT)
}
...
#define EJSVAL_TAG_UNDEFINED                                                   \
    ((uint32_t)(EJSVAL_TAG_CLEAR | EJSVAL_TYPE_UNDEFINED))
#define EJSVAL_TAG_STRING ((uint32_t)(EJSVAL_TAG_CLEAR | EJSVAL_TYPE_STRING))
#define EJSVAL_TAG_CLOSUREENV                                                  \
    ((uint32_t)(EJSVAL_TAG_CLEAR | EJSVAL_TYPE_CLOSUREENV))
...
#define EJSVAL_TAG_UNDEFINED                                                   \
    (uint32_t)(EJSVAL_TAG_MAX_DOUBLE | EJSVAL_TYPE_UNDEFINED)
#define EJSVAL_TAG_STRING (uint32_t)(EJSVAL_TAG_MAX_DOUBLE | EJSVAL_TYPE_STRING)
#define EJSVAL_TAG_CLOSUREENV                                                  \
    (uint32_t)(EJSVAL_TAG_MAX_DOUBLE | EJSVAL_TYPE_CLOSUREENV)
#define EJSVAL_TAG_BOOLEAN                                                     \
    (uint32_t)(EJSVAL_TAG_MAX_DOUBLE | EJSVAL_TYPE_BOOLEAN)
...
#define EJSVAL_SHIFTED_TAG_MAX_DOUBLE                                          \
    ((((uint64_t)EJSVAL_TAG_MAX_DOUBLE) << EJSVAL_TAG_SHIFT) | 0xFFFFFFFF)
#define EJSVAL_SHIFTED_TAG_INT32                                               \
    (((uint64_t)EJSVAL_TAG_INT32) << EJSVAL_TAG_SHIFT)
#define EJSVAL_SHIFTED_TAG_UNDEFINED                                           \
    (((uint64_t)EJSVAL_TAG_UNDEFINED) << EJSVAL_TAG_SHIFT)
#define EJSVAL_SHIFTED_TAG_STRING                                              \
    (((uint64_t)EJSVAL_TAG_STRING) << EJSVAL_TAG_SHIFT)
#define EJSVAL_SHIFTED_TAG_CLOSUREENV                                          \
    (((uint64_t)EJSVAL_TAG_CLOSUREENV) << EJSVAL_TAG_SHIFT)
#define EJSVAL_SHIFTED_TAG_BOOLEAN                                             \
    (((uint64_t)EJSVAL_TAG_BOOLEAN) << EJSVAL_TAG_SHIFT)
#define EJSVAL_SHIFTED_TAG_MAGIC                                               \
    (((uint64_t)EJSVAL_TAG_MAGIC) << EJSVAL_TAG_SHIFT)
#define EJSVAL_SHIFTED_TAG_NULL                                                \
    (((uint64_t)EJSVAL_TAG_NULL) << EJSVAL_TAG_SHIFT)
#define EJSVAL_SHIFTED_TAG_OBJECT                                              \
    (((uint64_t)EJSVAL_TAG_OBJECT) << EJSVAL_TAG_SHIFT)
...
#define EJSVAL_TYPE_TO_SHIFTED_TAG(type)                                       \
    (((uint64_t)EJSVAL_TYPE_TO_TAG(type)) << EJSVAL_TAG_SHIFT)
...
typedef enum EJSWhyMagic {
    ...
    EJS_NATIVE_ENUMERATE,  /* indicates that a custom enumerate hook forwarded
                           * to EJS_EnumerateState, which really means the object
                           * can be
    ...
    EJS_IS_CONSTRUCTING,   /* magic value passed to natives to indicate
                              construction */
...
#define STATIC_BUILD_EJSVAL(t, p)                                              \
    {                                                                          \
        .s = {.tag = (t), .payload = {.u32 = (uint32_t)(p)}}                   \
    }
#define STATIC_BUILD_DOUBLE_EJSVAL(v)                                          \
    { .asDouble = v }
#define STATIC_BUILD_BOOLEAN_EJSVAL(b)                                         \
    {                                                                          \
        .s = {.tag = EJSVAL_TAG_BOOLEAN, .payload = {.boo = (b)}}              \
    }

static EJS_ALWAYS_INLINE EJSValueTag EJSVAL_TO_TAG(ejsval_layout l) {
    return l.s.tag;
}
...
static EJS_ALWAYS_INLINE ejsval_layout BUILD_EJSVAL(EJSValueTag tag,
                                                    uint32_t payload) {
    ejsval_layout l;
...
static EJS_ALWAYS_INLINE EJSBool EJSVAL_IS_DOUBLE_IMPL(ejsval_layout l) {
    return (uint32_t)l.s.tag <= (uint32_t)EJSVAL_TAG_CLEAR;
}

static EJS_ALWAYS_INLINE ejsval_layout DOUBLE_TO_EJSVAL_IMPL(double d) {
    ejsval_layout l;
    l.asDouble = d;
...
static EJS_ALWAYS_INLINE EJSBool EJSVAL_IS_INT32_IMPL(ejsval_layout l) {
    return l.s.tag == EJSVAL_TAG_INT32;
}

static EJS_ALWAYS_INLINE int32_t EJSVAL_TO_INT32_IMPL(ejsval_layout l) {
    return l.s.payload.i32;
}

static EJS_ALWAYS_INLINE ejsval_layout INT32_TO_EJSVAL_IMPL(int32_t i) {
    ejsval_layout l;
...
static EJS_ALWAYS_INLINE EJSBool EJSVAL_IS_NUMBER_IMPL(ejsval_layout l) {
    EJSValueTag tag = l.s.tag;
    EJS_ASSERT(tag != EJSVAL_TAG_CLEAR);
    return (uint32_t)tag <= (uint32_t)EJSVAL_UPPER_INCL_TAG_OF_NUMBER_SET;
}

static EJS_ALWAYS_INLINE EJSBool EJSVAL_IS_UNDEFINED_IMPL(ejsval_layout l) {
    return l.s.tag == EJSVAL_TAG_UNDEFINED;
}

static EJS_ALWAYS_INLINE EJSBool EJSVAL_IS_STRING_IMPL(ejsval_layout l) {
...
static EJS_ALWAYS_INLINE EJSPrimString *EJSVAL_TO_STRING_IMPL(ejsval_layout l) {
    return l.s.payload.str;
}

static EJS_ALWAYS_INLINE EJSBool EJSVAL_IS_CLOSUREENV_IMPL(ejsval_layout l) {
...
static EJS_ALWAYS_INLINE EJSBool EJSVAL_IS_BOOLEAN_IMPL(ejsval_layout l) {
    return l.s.tag == EJSVAL_TAG_BOOLEAN;
}

static EJS_ALWAYS_INLINE EJSBool EJSVAL_TO_BOOLEAN_IMPL(ejsval_layout l) {
    return l.s.payload.boo;
}

static EJS_ALWAYS_INLINE ejsval_layout BOOLEAN_TO_EJSVAL_IMPL(EJSBool b) {
    ejsval_layout l;
...
static EJS_ALWAYS_INLINE EJSBool EJSVAL_IS_MAGIC_IMPL(ejsval_layout l) {
    return l.s.tag == EJSVAL_TAG_MAGIC;
}

static EJS_ALWAYS_INLINE EJSBool EJSVAL_IS_OBJECT_IMPL(ejsval_layout l) {
    return l.s.tag == EJSVAL_TAG_OBJECT;
}

static EJS_ALWAYS_INLINE EJSBool EJSVAL_IS_PRIMITIVE_IMPL(ejsval_layout l) {
...
EJSVAL_IS_OBJECT_OR_NULL_IMPL(ejsval_layout l) {
    ...
    return (uint32_t)l.s.tag >=
           (uint32_t)EJSVAL_LOWER_INCL_TAG_OF_OBJ_OR_NULL_SET;
}

static EJS_ALWAYS_INLINE EJSObject *EJSVAL_TO_OBJECT_IMPL(ejsval_layout l) {
    return l.s.payload.obj;
}

static EJS_ALWAYS_INLINE ejsval_layout OBJECT_TO_EJSVAL_IMPL(EJSObject *obj) {
    ejsval_layout l;
    EJS_ASSERT(obj);
...
static EJS_ALWAYS_INLINE EJSBool EJSVAL_IS_NULL_IMPL(ejsval_layout l) {
...
static EJS_ALWAYS_INLINE void *EJSVAL_TO_PRIVATE_PTR_IMPL(ejsval_layout l) {
    return l.s.payload.ptr;
}

static EJS_ALWAYS_INLINE EJSBool EJSVAL_IS_GCTHING_IMPL(ejsval_layout l) {
    /* gcc sometimes generates signed < without explicit casts. */
    return (uint32_t)l.s.tag >= (uint32_t)EJSVAL_LOWER_INCL_TAG_OF_GCTHING_SET;
}

static EJS_ALWAYS_INLINE void *EJSVAL_TO_GCTHING_IMPL(ejsval_layout l) {
    return l.s.payload.ptr;
}

static EJS_ALWAYS_INLINE EJSBool EJSVAL_IS_TRACEABLE_IMPL(ejsval_layout l) {
    return l.s.tag == EJSVAL_TAG_STRING || l.s.tag == EJSVAL_TAG_CLOSUREENV ||
           l.s.tag == EJSVAL_TAG_OBJECT;
}

static EJS_ALWAYS_INLINE uint32_t EJSVAL_TRACE_KIND_IMPL(ejsval_layout l) {
    return (uint32_t)(EJSBool)EJSVAL_IS_STRING_IMPL(l);
}

static EJS_ALWAYS_INLINE EJSBool EJSVAL_IS_SPECIFIC_INT32_IMPL(ejsval_layout l,
                                                               int32_t i32) {
    return l.s.tag == EJSVAL_TAG_INT32 && l.s.payload.i32 == i32;
}

static EJS_ALWAYS_INLINE EJSBool EJSVAL_IS_SPECIFIC_BOOLEAN(ejsval_layout l,
                                                            EJSBool b) {
    return (l.s.tag == EJSVAL_TAG_BOOLEAN) && (l.s.payload.boo == b);
}

static EJS_ALWAYS_INLINE ejsval_layout MAGIC_TO_EJSVAL_IMPL(EJSWhyMagic why) {
    ejsval_layout l;
...
static EJS_ALWAYS_INLINE EJSBool EJSVAL_SAME_TYPE_IMPL(ejsval_layout lhs,
                                                       ejsval_layout rhs) {
...
#define STATIC_BUILD_EJSVAL(tag, v)                                            \
    { .asBits = (((uint64_t)(uint32_t)tag) << EJSVAL_TAG_SHIFT) | v }
#define STATIC_BUILD_DOUBLE_EJSVAL(v)                                          \
    { .asDouble = v }
#define STATIC_BUILD_BOOLEAN_EJSVAL(b)                                         \
    { .asBits = ((uint64_t)(uint32_t)b) | EJSVAL_SHIFTED_TAG_BOOLEAN }
...
static EJS_ALWAYS_INLINE ejsval_layout INT32_TO_EJSVAL_IMPL(int32_t i32) {
    ejsval_layout l;
...
static EJS_ALWAYS_INLINE EJSBool EJSVAL_SAME_TYPE_IMPL(ejsval_layout lhs,
    ...
    return (lbits <= EJSVAL_SHIFTED_TAG_MAX_DOUBLE &&
            rbits <= EJSVAL_SHIFTED_TAG_MAX_DOUBLE) ||
...
static EJS_ALWAYS_INLINE double EJS_CANONICALIZE_NAN(double d) {
    if (EJS_UNLIKELY(d != d)) {
        ejsval_layout l;
